...
function Vercel(props: HTMLChakraProps<"svg">) {
  return (
    <chakra.svg
      fill="none"
    ...
    >
      <path
        d="M.5 3.75C.5 1.953 1.95.5 3.732.5h148.536a3.242 3.242 0 0 1 3.232 3.25v22.5c0 1.797-1.45 3.25-3.232 3.25H3.732A3.241 3.241 0 0 1 .5 26.25V3.75Z"
        fill={useColorModeValue(theme.colors.white, theme.colors.gray[900])}
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="m14.928 9.75 5.971 10.5H8.957l5.971-10.5Z"
        fill={useColorModeValue(theme.colors.gray[800], theme.colors.gray[50])}
      />
      <path
        d="M29.857 0v30"
        stroke={useColorModeValue(
